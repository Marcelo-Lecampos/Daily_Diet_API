...
| GET    | `http://localhost:3333/meals/summary`                | Nenhum                                                                                  | O usuário deve estar logado (ter realizado um post) para poder acessar este endpoint. Exemplo de Resposta: `json { "summaryMeals": { "totalMeals": 4, "totalMealsInDiet": 3, "totalMealsOutDiet": 1 } }` |
